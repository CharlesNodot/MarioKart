...
run_tests: google_tests.o Mario.o Character.o
	g++ $(CXXFLAGS) -o run_tests google_tests.o Mario.o Character.o googletest-release-1.10.0/build/lib/libgtest.a googletest-release-1.10.0/build/lib/libgtest_main.a -pthread
...
clean:
	rm google_tests.o run_tests Character.o Mario.o
